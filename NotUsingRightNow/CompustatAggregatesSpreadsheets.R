...
output_files = c(AggregatesSpreadsheet = 'SpreadsheetOutputs/CompustatAggregatesFeb2021.xlsx')

dtcut = read_feather_dt(input_data['dtcutForSpreadsheets'])
dtcut = dtcut[is_a_utility == F]
...
wb_filename = output_files['AggregatesSpreadsheet']
